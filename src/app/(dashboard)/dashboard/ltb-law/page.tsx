...
export default function LtbLawPage() {
  const [province, setProvince] = useState('');
  const [result, setResult] = useState<SummarizeLTBLawOutput | null>(null);
  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight font-headline">LTB Law Summary</h1>
          <p className="text-muted-foreground">
            Get AI-powered summaries of Landlord and Tenant Board (LTB) laws for any Canadian province or territory.
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Choose a province or territory to get a summary of its LTB laws.
          </CardDescription>
        </CardHeader>
        <CardContent>
